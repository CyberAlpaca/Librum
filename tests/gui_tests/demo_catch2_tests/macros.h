...
#define CHECK_FALSE_MSG(cond, msg) do { INFO(msg); CHECK_FALSE(cond); } while((void)0, 0)
#define REQUIRE_FALSE_MSG(cond, msg) do { INFO(msg); REQUIRE_FALSE(cond); } while((void)0, 0)
